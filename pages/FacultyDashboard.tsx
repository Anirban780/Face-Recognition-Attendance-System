...
const FacultyDashboard: React.FC<FacultyDashboardProps> = ({ onNavigate }) => {
  ...
  // ✅ One active session at a time per faculty (from AppContext/backend rule)
        ...
        <div className="lg:col-span-1 bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
          ...
          {activeSession ? (
            ...
            <div className="space-y-6">
              ...
              >
                <Square className="mr-2" size={18} fill="currentColor" /> End
                Class Session
              </button>
            ...
            <div className="space-y-4">
              ...
              >
                <Play className="mr-2" size={18} fill="currentColor" /> Start
                Class Session
              </button>
            </div>
          )}

...
import { ScanFace, ArrowRight, Lock, Users, School, Key, User } from 'lucide-react';
...
const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (login(identifier, password)) {
      ...
      const user = users.find(u => (u.email === identifier || u.enrollmentNo === identifier));
    ...
    return (
      <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center bg-gray-50 p-4">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome back, {currentUser.name}!</h1>
          <p className="text-lg text-gray-600">You are logged in as {currentUser.role}.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
           ...
           >
             ...
             <h3 className="text-xl font-bold text-gray-900 mb-2">Give Attendance</h3>
             <p className="text-gray-500 mb-4">Launch the kiosk mode to mark attendance for an active live class.</p>
             <div className="flex items-center text-indigo-600 font-medium">
               Launch Kiosk <ArrowRight size={16} className="ml-2 group-hover:translate-x-1 transition-transform" />
             </div>
           </div>
           ...
           {currentUser.role === UserRole.FACULTY && (
             ...
             >
               ...
               <p className="text-gray-500 mb-4">Start sessions and view live statistics for your subjects.</p>
               <div className="flex items-center text-green-600 font-medium">
                 Go to Dashboard <ArrowRight size={16} className="ml-2 group-hover:translate-x-1 transition-transform" />
               </div>
             </div>
           )}
           ...
           {currentUser.role === UserRole.STUDENT && (
             ...
             >
               ...
               <h3 className="text-xl font-bold text-gray-900 mb-2">My Reports</h3>
               <p className="text-gray-500 mb-4">Check your attendance history and percentage per subject.</p>
               <div className="flex items-center text-blue-600 font-medium">
                 View Attendance <ArrowRight size={16} className="ml-2 group-hover:translate-x-1 transition-transform" />
               </div>
             </div>
           )}
        </div>
      ...
      <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-indigo-50">
         <div className="max-w-md mx-auto">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
              Smart Attendance with <span className="text-indigo-600">Face Recognition</span>
            </h1>
            <p className="text-lg text-gray-600 mb-10">
              Seamlessly mark attendance for live classes using our AI-powered kiosk system.
            </p>
      ...
      <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white">
        <div className="max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Email or Enrollment No</label>
          ...
          <div className="mt-12 bg-gray-50 p-6 rounded-xl border border-gray-200">
             <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Demo Credentials</h3>
             <div className="overflow-x-auto">
               <table className="min-w-full text-sm text-left">
                 <thead>
                   <tr className="border-b border-gray-200">
                     <th className="pb-2 font-medium text-gray-700">Role</th>
                     <th className="pb-2 font-medium text-gray-700">Enrollment / Email</th>
                     <th className="pb-2 font-medium text-gray-700">Password</th>
                   </tr>
                 </thead>
                 <tbody className="divide-y divide-gray-100">
                   <tr>
                     <td className="py-2 text-gray-600">Student</td>
                     <td className="py-2 font-mono text-gray-800">STU001</td>
                     <td className="py-2 font-mono text-gray-500">password123</td>
                   </tr>
                   <tr>
                     <td className="py-2 text-gray-600">Faculty</td>
                     <td className="py-2 font-mono text-gray-800">FAC001</td>
                     <td className="py-2 font-mono text-gray-500">admin</td>
                   </tr>
                   <tr>
                     <td className="py-2 text-gray-600">Admin</td>
                     <td className="py-2 font-mono text-gray-800">admin@edu.com</td>
                     <td className="py-2 font-mono text-gray-500">admin</td>
                   </tr>
                 </tbody>
               </table>
